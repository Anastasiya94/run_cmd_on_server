var getLocalization = function (culture) {
    ...
    switch (culture) {
    	case "ru":
			...
			pagershowrowsstring: "отображать строк:",
			pagerrangestring: " из ",
			pagerpreviousbuttonstring: "предыдущий",
			pagernextbuttonstring: "следующий",
			pagerfirstbuttonstring: "first",
			pagerlastbuttonstring: "last",
			groupsheaderstring: "Переместите сюда колонку для группировки",
			...
			filterstring: "Фильтр",
			filtershowrowstring: "Фильтровать по:",
			filterorconditionstring: "Или",
			filterandconditionstring: "И",
			filterselectallstring: "(Выбрать все)",
			filterchoosestring: "Please Choose:",
			filterstringcomparisonoperators: ['содержит', 'содержит(учитывать регистр)',
			'не содержит', 'не содержит(учитывать регистр)', 'начинается с', 'начинается с(учитывать регистр)',
			'заканчивается на', 'заканчивается на (учитывать регистр)', 'равно', 'равно(учитывать регистр)', 'неопределенно', 'не неопределенно','пусто', 'не пусто'],
			filternumericcomparisonoperators: ['равно', 'не равно', 'меньше', 'меньше или равно', 'больше', 'больше или равно'],
			filterdatecomparisonoperators: ['равно', 'не равно', 'меньше', 'меньше или равно', 'больше', 'больше или равно', 'неопределенно', 'не неопределенно'],
			filterbooleancomparisonoperators: ['равно', 'не равно'],
			validationstring: "Entered value is not valid",
			emptydatastring: "Нет данных",
			filterselectstring: "Фильтр",
			loadtext: "Загрузка",
